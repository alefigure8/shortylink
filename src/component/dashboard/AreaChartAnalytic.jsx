...
function AreaChartAnalytic({ mainSummary }) {
  const maxClicks =
    mainSummary?.dailyClicks.length > 0
      ? Math.max(...mainSummary.dailyClicks.map((el) => el.clicks))
      : 0;
  ...
  return (
    <AreaChart width={800} height={400} data={mainSummary?.dailyClicks}>
...
export default AreaChartAnalytic;
